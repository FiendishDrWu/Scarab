...
Scarab's source code is published in this repository.

Reviewing the source code is welcome but is not required before submitting a good-faith security report. Reports based on source review, observable executable behavior, release artifacts, or reproducible inputs are welcome.
